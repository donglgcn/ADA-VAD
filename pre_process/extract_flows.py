...
if __name__ == '__main__':
    ...
    dataset = get_dataset(dataset_name=args.dataset_name, dir=os.path.join(dataset_root,args.dataset_name), # os.path.join(args.proj_root, "data", args.dataset_name),
                          context_frame_num=1, mode=args.mode)
    if args.mode == "train":
        # of_save_dir = os.path.join(args.proj_root, "data", args.dataset_name, "training", "flows")
        of_save_dir = os.path.join(dataset_root, args.dataset_name, "training", "flows")
    else:
        # of_save_dir = os.path.join(args.proj_root, "data", args.dataset_name, "testing", "flows")
        of_save_dir = os.path.join(dataset_root, args.dataset_name, "testing", "flows")
